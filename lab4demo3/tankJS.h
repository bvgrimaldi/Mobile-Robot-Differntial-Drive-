...
Tank mode: Use Keys [Q] [A] and [P]  [qL] for levers. <br>[S] for left arm and [K] for right arm <br>
  ...
  ESP32 Received: <span id="acknowledge">  </span> <br>
        <button type="button" onclick="armup()"> &nbsp; Autonomous Mode &nbsp;  </button> <br>
        <button type="button" onclick="armdown()"> &nbsp; Gripper &nbsp;  </button> <br>
